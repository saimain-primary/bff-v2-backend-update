<template>
	...
	<nav class="navbar">
		<a href="#" class="sidebar-toggler" @click.prevent="toggleNavbar">
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
						...
						<ul class="list-unstyled p-1">
							...
							<li class="dropdown-item py-2" @click.prevent="logout">
								<a href="#" @click.prevent="logout" class="text-body ms-0">
									<span>Log Out</span>
								</a>
							</li>
						</ul>
